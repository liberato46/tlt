...
try:
	...
	def contact(bot, update):
		...
		bot.send_audio(chat_id=update.message.chat_id, audio=open("tlt_audios/TLT_v5_1_intro_v1.ogg", "rb"))
		bot.send_message(chat_id=update.message.chat_id, text="(2) Now click on \"Play\" to listen to Question 1")
		bot.send_audio(chat_id=update.message.chat_id, audio=open("tlt_audios/TLT_v5_1_question1_v1.ogg", "rb"))
	...
	def voice(bot, update):
		...
		if question_answered+1>6:
			...
			bot.send_audio(chat_id=update.message.chat_id, audio=open("tlt_audios/TLT_v5_1_question"+str(question_answered+1)+"_v1.ogg", "rb"))
